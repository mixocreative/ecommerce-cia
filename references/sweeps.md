...
S20 asks whether the detectors are looking. **S21 asks it of the test suite**, which is the detector everything else is trusted on. Five shapes, the first four confirmed in one codebase:
